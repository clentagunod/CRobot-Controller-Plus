...
@Composable
private fun RobotNameStatusLocal(
    viewModel: MainViewContract,
    screenSize: ScreenSizeModel,
    deviceName: String,
...
@Composable
private fun AvailableRobotFoundLocal(
    screenSize: ScreenSizeModel,
    viewModel: MainViewContract,
    bluetoothState: BluetoothState,
    scanningState: ScanningState,
